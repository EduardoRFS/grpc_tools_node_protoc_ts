...
export interface IBookServiceClient {
    getBook(request: book_pb.GetBookRequest, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    getBook(request: book_pb.GetBookRequest, metadata: grpc.Metadata, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    getBook(request: book_pb.GetBookRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    ...
    getGreatestBook(callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    getGreatestBook(metadata: grpc.Metadata, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    getGreatestBook(options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    getGreatestBook(metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
...
export class BookServiceClient extends grpc.Client implements IBookServiceClient {
    ...
    public getBook(request: book_pb.GetBookRequest, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    public getBook(request: book_pb.GetBookRequest, metadata: grpc.Metadata, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    public getBook(request: book_pb.GetBookRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientUnaryCall & PromiseLike<book_pb.GetBookRequest>;
    ...
    public getGreatestBook(callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    public getGreatestBook(metadata: grpc.Metadata, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    public getGreatestBook(options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
    public getGreatestBook(metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback?: (error: grpc.ServiceError | null, response: book_pb.Book) => void): grpc.ClientWritableStream<book_pb.GetBookRequest> & PromiseLike<book_pb.GetBookRequest>;
